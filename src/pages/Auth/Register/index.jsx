...
function Register(props) {
    return (
        <div className="flex flex-wrap pt-10 pb-20">
            <div className="w-full grid place-content-center text-center mb-12">
                <svg className="w-48" viewBox="0 0 113 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-full grid place-content-center">
                ...
                <button className="grid place-content-center bg-indigo-600 text-white rounded-xl mt-12">
            ...
            {/* <div className="w-5/12">
                <ul className="grid gap-8">
                    <li>
                        ...
                        <div>
                            <h3>Rápido</h3>
                            <p>Aprobación inmediata. Sin verificación de crédito.</p>
                        </div>
                    </li>
                    <li>
                        <span></span>
                        <div>
                            <h3>Cero costos</h3>
                            <p>0% interés, 0 costo alguno. Sólo pagas $20 al mes.</p>
                        </div>
                    </li>
                    <li>
                        <span></span>
                        <div>
                            ...
                            <p>Usamos cifrado 256-bit SSL para mantener su data segura.</p>
                        </div>
                    </li>
                </ul>
            </div> */}
